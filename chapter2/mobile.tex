...
\begin{itemize}
  ...
  \item By default, \idx{drag\et{}drop} is reserved to scroll the page.
...
Even when zooming manually, most actions rely on \idx{drag\et{}drop} and therefore are not even accessible, so it is impossible to move or delete a session.
