...
Though hacks and dirty fixes needed to be spilled all over the place because of \idx{Internet Explorer} quirks and bugs, that did not tarnish the overall architecture.
