\chapter{Development and Testing} % (fold)
...
\nicesectionending
\input{chapter3/usecases}
\nicesectionending
\input{chapter3/components}
\nicesectionending
...
\nicesectionending
\input{chapter3/testing}
\nicesectionending
\input{chapter3/deployment}
\nicechapterending
% chapter development_and_testing (end)