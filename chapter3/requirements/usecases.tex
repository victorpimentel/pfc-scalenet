...
All of those use cases are defined considering the desktop interface.
Since the third phase consists on developing another very different interface, more use cases have to be defined for that mobile version.

\begin{center}
  \begin{usecase}[Select tab (mobile)]
    \label{tab:usecaseselecttabmobile}%
    \usecaseactor{System user}
    \usecasepre{The application is fully loaded and it is not blocked.}
