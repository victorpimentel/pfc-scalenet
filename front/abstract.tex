...
This improvement has led to the emergence of highly complex web applications based on \idx{HTML}, \idx{CSS} and \idx{JavaScript}, distributing significant processing loads to the client.
...
The developed component, the \emph{Personal Network Administration Interface} (\idx{PNAI}), is only a small part of \idx{ScaleNet} that serves as an example application on this network.
