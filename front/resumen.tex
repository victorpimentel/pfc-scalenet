...
Esta mejora ha dado lugar a la aparición de aplicaciones web de una gran complejidad basadas en \idx{HTML}, \idx{CSS} y \idx{JavaScript}, distribuyendo una carga de procesamiento importante al cliente.
...
Dicha aplicación se enmarca dentro del proyecto \idx{ScaleNet} (2005-2009), una red de siguiente generación cuyo fin es un sistema que permita una integración escalable, rentable y eficiente de las diferentes tecnologías de acceso inalámbrico y por cable.
El componente desarrollado, la \emph{Interfaz de Administración de la Red Personal} (\idx{PNAI}), es solo una pequeña parte de \idx{ScaleNet} que sirve como ejemplo de aplicación sobre esta red.
