...
El componente desarrollado, la \emph{Interfaz de Administración de la Red Personal} (\ida{PNAI}), es solo una pequeña parte de \idx{ScaleNet} que sirve como ejemplo de aplicación sobre esta red.
